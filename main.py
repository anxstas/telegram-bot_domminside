...
gad7_descriptions = {
    ...
    "Легкая тревожность": "Вы испытываете легкую тревожность, которая может усиливаться. Важно прислушаться к себе. Не игнорируйте. Обратитесь за помощью.",
    "Умеренная тревожность": "Проявляются регулярные симптомы тревоги. Важно прислушаться к себе. Не игнорируйте. Обратитесь за помощью.",
...
def send_gad7_question(chat_id):
    ...
    markup = types.ReplyKeyboardMarkup(resize_keyboard=True, one_time_keyboard=False)
    markup.add("0 — Совсем нет", "1 — Немного", "2 — Заметно", "3 — Почти каждый день")
...
phq9_descriptions = {
    "Минимальная депрессия": "Ваше настроение в пределах нормы. Можно проконсультироваться о способах заботы о себе.",
    "Легкая депрессия": "Присутствуют первые признаки подавленности. Важно прислушаться к себе. Не игнорируйте. Обратитесь за помощью.",
    "Умеренная депрессия": "Симптомы депрессии выражены ярче. Важно прислушаться к себе. Не игнорируйте. Обратитесь за помощью.",
    "Тяжелая депрессия": "Выраженная депрессия с серьёзным влиянием на повседневную жизнь. Важно заняться собой сейчас."
}
...
def send_phq9_question(chat_id):
    ...
    markup = types.ReplyKeyboardMarkup(resize_keyboard=True, one_time_keyboard=False)
    markup.add("0 — Совсем нет", "1 — Иногда", "2 — Часто", "3 — Почти каждый день")
    bot.send_message(chat_id, f"{step+1}. {q}", reply_markup=markup)
