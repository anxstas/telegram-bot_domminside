...
🤿 Пойти глубже — там есть важное и интересное для тебя, а ещё — детальнее о подходе. 
...
Ну и, конечно же, 🚨 SOS без соплей, куда можно заходить только в крайних эмоциях и очень осторожно.""",      
...
def interpret_dumpling_result(chat_id, uid):
    ...
    if result == 'classic':
        ...
        desc = (
            "🔥 Ты — Пельмень-Флексер.\n\n"
            "Ты — огонь. RHCP  мире пельменей. Когда ты входишь в сковородку, вся кухня знает.\n"
