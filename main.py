...
# --- Вопросы CES-D ---
cesd_questions = [
    "Я чувствовал(а) себя подавленным(ой).", "Мне трудно было начать делать что-то новое.",
    "Я чувствовал(а), что у меня нет сил на повседневные дела.", "Мне казалось, что всё требует чрезмерных усилий.",
    "Я чувствовал(а) себя одиноким(ой).", "Мне было трудно сосредоточиться на том, что я делаю.",
    "Я ощущал(а) грусть почти весь день.", "Я чувствовал(а), что всё, что я делаю — бесполезно.",
    "Я терял(а) интерес к тому, что раньше радовало.", "Я чувствовал(а), что люди меня не понимают.",
    "Мне не хватало энергии.", "Я чувствовал(а), что ничто не радует.", "Я ощущал(а), что никто меня не любит.",
    "Мне казалось, что меня никто не поддерживает.", "Я спал(а) больше или меньше обычного.",
    "Я плохо ел(а) или переедал(а).", "Я чувствовал(а), что жизнь бессмысленна.",
    "Я избегал(а) общения с людьми.", "Я чувствовал(а) тревогу или раздражение без причины.",
    "Мне казалось, что я ничего не стою."
]
