...
def gpt_flow(message):
    ...
    if step == 1:
        ...
        bot.send_message(message.chat.id, "Твой вопрос важный. Как и все, что происходит с тобой. Хочешь, напиши о нем Стасу лично на @anxstas — он ответит как только прочитает. Это бесплатно.")
