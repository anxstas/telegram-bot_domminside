...
🆘 Срочная помощь — если сейчас совсем тяжко.""",
    ...
    bot.send_message(
        message.chat.id,
        """👇 А здесь - мой канал в телеграм (о тревоге) и ютуб, где идет "Тоска'на". А еще - та самая песня, написанная в моих ГТР и ТДР, через которую я в течение года принимал смерть папы. И короткометражка, снятая в процессе исследования своей Тени ⤵️""",
