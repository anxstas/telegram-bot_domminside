...
# --- Уровни и описания ---
gad7_levels = [
    (0, 4, "Минимальная тревожность", "Вы держитесь уверенно — тревожность не выходит за пределы нормы. Продолжайте заботиться о себе."),
    (5, 9, "Легкая тревожность", "Вы часто внутренне напряжены. Это не критично, но уже требует внимания."),
    (10, 14, "Умеренная тревожность", "Тревога стала заметной частью жизни. Стоит поговорить об этом со специалистом."),
    (15, 21, "Тяжелая тревожность", "Высокий уровень тревожности мешает жить. Поддержка важна — не откладывайте её.")
]

phq9_levels = [
    (0, 4, "Минимальная депрессия", "Эмоциональный фон стабильный. Всё под контролем, но не забывайте о профилактике."),
    (5, 9, "Легкая депрессия", "Есть признаки подавленности. Лучше не игнорировать это состояние."),
    (10, 14, "Умеренная депрессия", "Эмоциональное истощение уже мешает. Поддержка может изменить многое."),
    (15, 19, "Умеренно-тяжелая депрессия", "Состояние серьезное. Обратиться к специалисту — важный шаг."),
    (20, 27, "Тяжелая депрессия", "Очень тяжёлое состояние. Помощь нужна — и это абсолютно нормально.")
]
