...
stai_questions = [
    "Я чувствую себя спокойно.", "Я напряжён.", "Я обеспокоен возможными неприятностями.",
    "Я чувствую себя свободно.", "Я нервничаю.", "Я испытываю чувство тревоги.",
    "Я чувствую себя уверенно.", "Я раздражён.", "Я подавлен.",
    "Я испытываю страх.", "Я утомлён.", "Я чувствую скованность."
]
